...
public class AffichageSuite {
    public static void main(String[] args) {
        ...
        System.out.println("Affichage des nombres de 1 à 10 inclus (FOR) :");
        for (int i = 1; i <= 10; i++) {
        ...
        System.out.println("Affichage des nombres pairs entre 0 et 10 inclus (FOR) :");
        for (int i = 0; i <= 10; i++) {
            if(i % 2 == 0){
                System.out.println(i);
            }
        ...
        System.out.println("Affichage des nombres impairs entre 0 et 9 inclus (FOR) :");
        for (int i = 0; i <= 9; i++) {
            if(i % 2 != 0){
                System.out.println(i);
            }
        ...
        System.out.println("Affichage des nombres de 1 à 10 inclus (WHILE) :");
        ...
        System.out.println("Affichage des nombres pairs entre 0 et 10 inclus (WHILE) :");
        ...
        System.out.println("Affichage des nombres impairs entre 0 et 9 inclus (WHILE) :");
        byte index3 = 0;
